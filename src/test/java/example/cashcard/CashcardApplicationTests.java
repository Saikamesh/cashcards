...
class CashcardApplicationTests {
	...
	@Test
	void shouldRejectUserWhoAreNotOwners() {
		ResponseEntity<String> response = restTemplate
				.withBasicAuth("hank", "1234abcd")
				.getForEntity("/cashcards/99", String.class);
	...
	void shouldNotUpdateACashCardThatDoesNotExists() {
		...
		ResponseEntity<Void> response = restTemplate
				.withBasicAuth("sarah1", "abc123")
				.exchange("/cashcards/991", HttpMethod.PUT, request, Void.class);
		assertThat(response.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
	}
	...
	void shouldNotDeleteACashCardThatDoesNotExist() {
		ResponseEntity<Void> response = restTemplate
				.withBasicAuth("sarah1", "abc123")
				.exchange("/cashcards/111", HttpMethod.DELETE, null, Void.class);
		assertThat(response.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
	}
